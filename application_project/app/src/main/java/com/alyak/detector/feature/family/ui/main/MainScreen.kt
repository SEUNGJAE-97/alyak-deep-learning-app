...
import com.alyak.detector.push.ui.NotificationSection
...
fun MainScreen(
    ...
    BackHandler(enabled = isNotificationSideSheetOpen) {
        isNotificationSideSheetOpen = false
    }
    ...
    Box(modifier = Modifier.fillMaxSize()) {
        Scaffold(
            topBar = {
                HeaderForm(
                    name = name,
                    onNotificationClick = { isNotificationSideSheetOpen = true },
                )
            },
        ) { paddingValues ->
            Column(
        ...
        if (isNotificationSideSheetOpen) {
        ...
        AnimatedVisibility(
            visible = isNotificationSideSheetOpen,
            ...
            Surface(
                ...
                Column(modifier = Modifier.fillMaxSize()) {
                    Row(
                        ...
                        IconButton(onClick = { isNotificationSideSheetOpen = false }) {
                            Icon(
                    ...
                    HorizontalDivider(color = colorResource(R.color.lightGray))
