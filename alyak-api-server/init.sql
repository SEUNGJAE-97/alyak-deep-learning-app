...
INSERT INTO users (name, email, password, phone_number, gender, resident_registration_number) VALUES
('김철수', 'kim.chulsoo@email.com', 'password123', '010-1234-5678', 'M', '900101-1234567'),
...
('강하은', 'kang.haeun@email.com', 'password123', '010-0000-1111', 'F', '100723-0000000');

-- Insert dummy families data
INSERT INTO families (family_name, description) VALUES
('김가족', '김철수 가족 - 4인 가족'),
('이가족', '이영희 가족 - 3인 가족'),
('박가족', '박민수 가족 - 5인 가족'),
('최가족', '최수진 가족 - 2인 가족'),
...
-- Insert dummy family_members data
-- 김가족 (Family ID: 1)
